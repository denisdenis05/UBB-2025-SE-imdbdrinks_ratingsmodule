...
public class DatabaseReviewRepositoryHelperCreateAddReviewCommandTest
{
    private SqlConnection _connection;
    private const int TestRatingId = 1;
    private const int TestUserId = 999;
    private const string TestContent = "This is a test review";
    ...
    [Test]
    public void CreateAddReviewCommand_WhenCalled_CreatesCommandWithCorrectParameters()
    {
        // Arrange
        ...
        // Act
        var command = DatabaseReviewRepositoryHelper.CreateAddReviewCommand(_connection, review);

        // Assert
        Assert.That(command.CommandText, Is.EqualTo(ReviewQueries.AddReviewQuery), "Command text should match the query");
    ...
    [Test]
    public void CreateAddReviewCommand_WhenCalledWithNullConnection_CreatesCommandButCannotExecute()
    {
        // Arrange
        var review = new Review
        {
        ...
        // Act
        var command = DatabaseReviewRepositoryHelper.CreateAddReviewCommand(null!, review);
    ...
    [Test]
    public void CreateAddReviewCommand_WhenCalledWithNullReview_ThrowsNullReferenceException()
    {
        // Act & Assert
        Assert.Throws<NullReferenceException>(() => 
            DatabaseReviewRepositoryHelper.CreateAddReviewCommand(_connection, null!),
